...
async function rasterText(text, fontFamily = 'monospace', fontSize = 40, lineHeight = 40, textColor = '#000', backgroundColor = '#fff') {
...
async function findDevice(searchDelay = 5000) {
...
async function print(imgQueue, device, blankLinesAfterPrint = 40) {
    if (!device) {
